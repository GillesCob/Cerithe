...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-dvh bg-gray-50">
      {/* Navbar toujours montee : c'est elle qui resout activeProfileId (useGetAllProfiles +
          effet de secours sur profiles[0]), la garder derriere le loader ci-dessous creerait
          un blocage circulaire (la requete des biens attend un profil que la Navbar ne peut
          jamais fournir puisqu'elle ne serait jamais montee). Incident du 10/08. */}
      <Navbar />
